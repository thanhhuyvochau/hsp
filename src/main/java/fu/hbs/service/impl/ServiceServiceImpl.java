...
public class ServiceServiceImpl implements ServiceService {
    ...
    public Page<Service> getAllServices(Pageable pageable) {
        List<Service> allServices = serviceRepository.findAll(); // Lấy toàn bộ dịch vụ
        return paginateList(allServices, pageable); // Phân trang danh sách toàn bộ dịch vụ
    }

    @Override
    public Page<Service> searchByName(String serviceName, Pageable pageable) {
        List<Service> filteredServices = serviceRepository.findByServiceNameContaining(serviceName); // Tìm kiếm trong danh sách dịch vụ
        return paginateList(filteredServices, pageable); // Phân trang kết quả tìm kiếm
    }

    // Phân trang danh sách
    private Page<Service> paginateList(List<Service> list, Pageable pageable) {
